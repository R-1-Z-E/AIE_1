...
Победитель: Boosting_HGB, так как он показал наилучший результат по ROC-AUC на test (≈0.905), а также высокий F1 (≈0.692), что важно для качества по редкому классу.
